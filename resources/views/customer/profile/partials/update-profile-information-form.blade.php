                ...
                <div class="col-md-6">
                    <div class="mb-3 form-group">
                        ...
                        <x-text-input id="name" name="name" type="text" class="form-control"
                            :value="old('name', $user->name)" required autofocus autocomplete="name" placeholder="Customer Name" />
                ...
                <div class="col-md-6">
                    <div class="mb-3 form-group">
                        ...
                        <x-text-input id="email" name="email" type="email" class="form-control"
                            :value="old('email', $user->email)" required autocomplete="username" placeholder="Customer Email" />
                ...
                <div class="col-md-6">
                    <div class="mb-3 form-group">
                        ...
                        <x-text-input id="phone" name="phone" type="text" class="form-control"
                            :value="old('phone', $user->phone)" autofocus autocomplete="phone" placeholder="Customer Phone No" />
                ...
                <div class="col-md-6">
                    <div class="mb-3 form-group">
                        ...
                        <x-text-input id="address" name="address" type="text" class="form-control"
                            :value="old('address', $user->address)" autofocus autocomplete="address" placeholder="Customer Address" />
