        ...
        <div class="flex flex-wrap w-full mb-[-24px]">
            <div class="min-[992px]:w-[50%] w-full px-[12px] mb-[24px]">
                <div class="bb-about-img sticky top-[0]">
                    <img src="{{ asset('frontend/img/about/one.png') }}" alt="about-one" class="w-full">
                </div>
            </div>
                ...
                <div class="bb-about-contact h-full flex flex-col justify-center">
                    <div class="section-title pb-[12px] px-[12px] flex justify-start max-[991px]:flex-col max-[991px]:justify-center max-[991px]:text-center"
                        ...
                        <div class="section-detail max-[991px]:mb-[12px]">
                            <h2
                                class="bb-title font-quicksand tracking-[0.03rem] mb-[0] p-[0] text-[25px] font-bold text-[#3d4750] inline capitalize leading-[1] max-[767px]:text-[23px]">
                                About the <span class="text-[#6c7fd8]">BlueBerry</span></h2>
                        </div>
                    </div>
                    <div class="about-inner-contact px-[12px] mb-[14px]" data-aos="fade-up" data-aos-duration="1000"
                        data-aos-delay="400">
                        <h4
                            class="font-quicksand tracking-[0.03rem] leading-[1.2] mb-[20px] text-[18px] text-[#3d4750] font-bold italic">
                            Farm-fresh Goodness, just a click Away.</h4>
                        <p
                            class="font-Poppins mb-[16px] text-[14px] text-[#686e7d] font-light leading-[28px] tracking-[0.03rem]">
                    ...
                    <div class="bb-vendor-rows flex flex-wrap w-full mb-[-24px]" data-aos="fade-up"
                        data-aos-duration="1000" data-aos-delay="600">
                        <div class="min-[576px]:w-[33.33%] w-full px-[12px] mb-[24px]">
                            <div
                                class="bb-vendor-box p-[20px] bg-[#f8f8fb] border-[1px] border-solid border-[#eee] rounded-[20px]">
                                <div class="bb-count mb-[12px] max-[1399px]:mb-[8px]">
                                    <h5
                                        class="counter font-quicksand tracking-[0.03rem] text-[32px] leading-[24px] text-[#3d4750] font-bold max-[1399px]:text-[28px] text-center">
                                        200 +</h5>
                                </div>
                                <div class="inner-text">
                                    <p
                                        class="font-Poppins font-light tracking-[0.03rem] text-[14px] leading-[18px] text-[#686e7d] mb-[0] text-center">
                                        vendors</p>
                                </div>
                            </div>
                        </div>
...
<section class="section-services py-[50px] max-[1199px]:py-[35px]">
    <div
        ...
        <div class="flex flex-wrap w-full mb-[-24px]">
            <div class="w-full px-[12px]">
                <div class="section-title text-center mb-[20px] pb-[20px] z-[5] relative flex justify-center max-[991px]:pb-[0]"
                    data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                    <div class="section-detail max-[991px]:mb-[12px]">
                        <h2
                            ...
                            Our <span class="text-[#6c7fd8]">Services</span></h2>
                        <p
                            class="font-Poppins max-w-[400px] mt-[10px] text-[14px] text-[#686e7d] leading-[18px] font-light tracking-[0.03rem] max-[991px]:mx-[auto]">
                            Customer service should not be a department. It should be the entire company.</p>
                    </div>
                </div>
            </div>
            <div class="min-[992px]:w-[25%] min-[768px]:w-[50%] w-full px-[12px] mb-[24px]" data-aos="fade-up"
                ...
                <div
                    ...
                    <div class="services-contact">
                        <h4
                            class="font-quicksand leading-[1.2] tracking-[0.03rem] mb-[8px] text-[18px] font-bold text-[#3d4750]">
                            Free Shipping</h4>
                        <p class="font-Poppins font-light tracking-[0.03rem] text-[14px] leading-[20px] text-[#686e7d]">
            ...
            <div class="w-full px-[12px]">
                <div class="section-title text-center mb-[20px] pb-[20px] z-[5] relative flex justify-center max-[991px]:pb-[0]"
                    ...
                    <div class="section-detail max-[991px]:mb-[12px]">
                        <h2
                            class="bb-title font-quicksand mb-[0] p-[0] text-[25px] font-bold text-[#3d4750] relative inline capitalize leading-[1] tracking-[0.03rem] max-[767px]:text-[23px]">
                            Our <span class="text-[#6c7fd8]">Team</span></h2>
                        <p
                            class="font-Poppins max-w-[400px] mt-[10px] text-[14px] text-[#686e7d] leading-[18px] font-light tracking-[0.03rem] max-[991px]:mx-[auto]">
                ...
                <div class="bb-team owl-carousel">
                    <div class="bb-team-box" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                        <div class="bb-team-img mb-[20px] relative h-full flex items-center overflow-hidden">
                            <div
                                class="bb-team-socials transition-all duration-[0.3s] ease-in-out bg-[#fff] rounded-tl-[20px] rounded-bl-[20px] absolute right-[-38px]">
                                <div class="inner-shape relative"></div>
                                <ul class="mb-[0] py-[20px] px-[10px]">
                                    <li class="bb-social-link leading-[28px] pb-[10px]">
                                        <a href="javascript:void(0)"><i
                                                class="ri-facebook-fill text-[16px] hover:text-[#6c7fd8]"></i></a>
                                    </li>
                                    <li class="bb-social-link leading-[28px] pb-[10px]">
                                        <a href="javascript:void(0)"><i
                                    ...
                                    <li class="bb-social-link leading-[28px]">
                                        <a href="javascript:void(0)"><i
                                                class="ri-linkedin-fill text-[16px] hover:text-[#6c7fd8]"></i></a>
                                    </li>
                                </ul>
                            </div>
                            <img src="{{ asset('frontend/img/team/1.jpg') }}" alt="team-1" class="w-full rounded-[20px]">
                        </div>
                        <div class="bb-team-contact text-center">
                            <h5
                                class="font-quicksand tracking-[0.03rem] leading-[1.2] text-[18px] font-bold text-[#3d4750]">
                                Elena Wilson</h5>
                            <p
                                class="font-Poppins font-light leading-[28px] tracking-[0.03rem] text-[15px] text-[#686e7d]">
                                Manager</p>
                        </div>
                    </div>
                    <div class="bb-team-box" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
                        <div class="bb-team-img mb-[20px] relative h-full flex items-center overflow-hidden">
                            ...
                            <img src="{{ asset('frontend/img/team/2.jpg') }}" alt="team-2" class="w-full rounded-[20px]">
                        </div>
                        <div class="bb-team-contact text-center">
                            <h5
                                class="font-quicksand tracking-[0.03rem] leading-[1.2] text-[18px] font-bold text-[#3d4750]">
                    ...
                    <div class="bb-team-box" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
                        <div class="bb-team-img mb-[20px] relative h-full flex items-center overflow-hidden">
                            ...
                            <img src="{{ asset('frontend/img/team/3.jpg') }}" alt="team-3" class="w-full rounded-[20px]">
                        </div>
                        <div class="bb-team-contact text-center">
                            <h5
                                class="font-quicksand tracking-[0.03rem] leading-[1.2] text-[18px] font-bold text-[#3d4750]">
                    ...
                    <div class="bb-team-box" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="800">
                        <div class="bb-team-img mb-[20px] relative h-full flex items-center overflow-hidden">
                            ...
                            <img src="{{ asset('frontend/img/team/4.jpg') }}" alt="team-4" class="w-full rounded-[20px]">
                        </div>
                        <div class="bb-team-contact text-center">
                            <h5
                                class="font-quicksand tracking-[0.03rem] leading-[1.2] text-[18px] font-bold text-[#3d4750]">
